---
title: "Common Art Gallery Exhibition Installation Readiness Mistakes and How to Prevent Them"
...
Artwork arrival, framing, hardware, wall plans, labels, lighting, artist decisions, labor, and event deadlines mature independently. The recurring failures are usually process-design problems rather than motivation problems. For independent commercial galleries and artist-run exhibition spaces, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the installation item

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every exhibition item reaches install with required object, hardware, placement, label, and approval decisions ready When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open installation item needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct installation item identifier and source without asking the original owner?
