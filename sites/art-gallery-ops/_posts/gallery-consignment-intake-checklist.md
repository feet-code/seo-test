---
title: "Art Gallery Consignment Intake Tracking Checklist for Independent Commercial Galleries And Artist-Run Exhibition Spaces"
excerpt: "A copyable quality-control checklist for independent commercial galleries and artist-run exhibition spaces, with concrete fields, decision rules, and implementation steps."
...
A checklist for art gallery consignment intake tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent commercial galleries and artist-run exhibition spaces and centers on one result: **every accepted artwork has a complete consignment record, condition, custody location, and commercial terms**.

## Before the work starts

- Confirm Consigned Artwork identifier and source
...
- Update Open the consigned artwork from a verified source
...
- Update Verify the outcome and close or reschedule the consigned artwork
...
- [ ] Review records where a new consigned artwork is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the consigned artwork
...
Choose one metric before the next cycle. Good options for this workflow are Consigned Artwork ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
