---
title: "Art Gallery Exhibition Installation Readiness Checklist for Independent Commercial Galleries And Artist-Run Exhibition Spaces"
...
A checklist for art gallery exhibition installation readiness should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent commercial galleries and artist-run exhibition spaces and centers on one result: **every exhibition item reaches install with required object, hardware, placement, label, and approval decisions ready**.

## Before the work starts

- Confirm Installation Item identifier and source
...
- Update Open the installation item from a verified source
...
- Update Verify the outcome and close or reschedule the installation item
...
- [ ] Review records where a new installation item is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the installation item
...
Choose one metric before the next cycle. Good options for this workflow are Installation Item ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
