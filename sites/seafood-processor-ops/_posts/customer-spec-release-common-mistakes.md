---
title: "Common Seafood Customer Specification And Order Release Mistakes and How to Prevent Them"
...
Species, cut, size, pack, label, source claim, substitution, price, and ship timing vary by account and order. The recurring failures are usually process-design problems rather than motivation problems. For small seafood processors, wholesalers, and dock-to-market teams, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the customer specification

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every production order is released against the current approved customer specification and substitution decision When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open customer specification needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct customer specification identifier and source without asking the original owner?
