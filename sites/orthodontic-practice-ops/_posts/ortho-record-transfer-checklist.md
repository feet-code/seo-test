---
title: "Orthodontic Patient Record Transfer Tracking Checklist for Independent Orthodontic Practices And Small Specialty Dental Groups"
excerpt: "A copyable quality-control checklist for independent orthodontic practices and small specialty dental groups, with concrete fields, decision rules, and implementation steps."
...
A checklist for orthodontic patient record transfer tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent orthodontic practices and small specialty dental groups and centers on one result: **every authorized record transfer has a defined scope, secure delivery evidence, and verified receipt or exception**.

## Before the work starts

- Confirm Record-Transfer Request identifier and source
...
- Update Open the record-transfer request from a verified source
...
- Update Verify the outcome and close or reschedule the record-transfer request
...
- [ ] Review records where a new record-transfer request is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the record-transfer request
...
Choose one metric before the next cycle. Good options for this workflow are Record-Transfer Request ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
