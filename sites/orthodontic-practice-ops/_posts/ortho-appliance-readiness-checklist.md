---
title: "Orthodontic Appliance Delivery Tracking Checklist for Independent Orthodontic Practices And Small Specialty Dental Groups"
...
A checklist for orthodontic appliance delivery tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent orthodontic practices and small specialty dental groups and centers on one result: **every appliance-delivery visit is scheduled against a received and reviewed case or an explicit clinical-office decision**.

## Before the work starts

- Confirm Appliance Case identifier and source
...
- Update Open the appliance case from a verified source
...
- Update Verify the outcome and close or reschedule the appliance case
...
- [ ] Review records where a new appliance case is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the appliance case
...
Choose one metric before the next cycle. Good options for this workflow are Appliance Case ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
