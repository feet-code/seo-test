---
title: "Common Orthodontic Appliance Delivery Tracking Mistakes and How to Prevent Them"
...
Prescription, scan or impression, lab questions, ship status, appointment timing, receipt check, and patient notice can become disconnected. The recurring failures are usually process-design problems rather than motivation problems. For independent orthodontic practices and small specialty dental groups, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the appliance case

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every appliance-delivery visit is scheduled against a received and reviewed case or an explicit clinical-office decision When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open appliance case needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct appliance case identifier and source without asking the original owner?
