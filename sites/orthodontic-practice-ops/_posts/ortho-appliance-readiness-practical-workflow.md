---
title: "Orthodontic Appliance Delivery Tracking: A Practical Workflow"
...
Prescription, scan or impression, lab questions, ship status, appointment timing, receipt check, and patient notice can become disconnected. For independent orthodontic practices and small specialty dental groups, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every appliance-delivery visit is scheduled against a received and reviewed case or an explicit clinical-office decision**.
...
- a new appliance case is created or its due window changes
