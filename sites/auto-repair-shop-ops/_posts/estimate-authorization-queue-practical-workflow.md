---
title: "Repair Estimate Authorization Tracking: A Practical Workflow"
...
### 1. Open the authorization request from the repair order

Record **Repair order and vehicle** at this point, name the person responsible, and define the evidence that allows the work to move to the next step. The exit condition should be observable: either the team can deliver the estimate through the agreed channel, or the record remains open with a reason and next action.

### 2. Deliver the estimate through the agreed channel

Record **Estimate version and amount** at this point, name the person responsible, and define the evidence that allows the work to move to the next step. The exit condition should be observable: either the team can capture the approved, declined, or questioned scope, or the record remains open with a reason and next action.

### 3. Capture the approved, declined, or questioned scope

Record **Work items awaiting approval** at this point, name the person responsible, and define the evidence that allows the work to move to the next step. The exit condition should be observable: either the team can resolve price and scope changes, or the record remains open with a reason and next action.

### 4. Resolve price and scope changes

Record **Customer and preferred channel** at this point, name the person responsible, and define the evidence that allows the work to move to the next step. The exit condition should be observable: either the team can release authorized work or close the request, or the record remains open with a reason and next action.

### 5. Release authorized work or close the request

Record **Estimate delivered time** at this point, name the person responsible, and define the evidence that allows the work to move to the next step. The exit condition should be observable: either the team can close the record and review the outcome, or the record remains open with a reason and next action.
