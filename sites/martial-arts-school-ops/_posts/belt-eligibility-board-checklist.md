---
title: "Martial Arts Belt Testing Eligibility Checklist for Independent Martial Arts Academies And Multi-Program Dojos"
...
A checklist for martial arts belt testing eligibility should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent martial arts academies and multi-program dojos and centers on one result: **every testing invitation reflects the school's recorded progression criteria and an explicit instructor decision**.

## Before the work starts

- Confirm Progression Review identifier and source
...
- Update Open the progression review from a verified source
...
- Update Verify the outcome and close or reschedule the progression review
...
- [ ] Review records where a new progression review is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the progression review
...
Choose one metric before the next cycle. Good options for this workflow are Progression Review ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
