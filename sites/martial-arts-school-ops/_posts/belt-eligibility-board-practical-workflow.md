---
title: "Martial Arts Belt Testing Eligibility: A Practical Workflow"
excerpt: "A step-by-step operating workflow for independent martial arts academies and multi-program dojos, with concrete fields, decision rules, and implementation steps."
...
Attendance, curriculum signoffs, instructor judgment, fees, equipment, and testing invitations are reconciled shortly before promotion events. For independent martial arts academies and multi-program dojos, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every testing invitation reflects the school's recorded progression criteria and an explicit instructor decision**.
...
- a new progression review is created or its due window changes
