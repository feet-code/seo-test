---
title: "Trial Student Follow-Up vs. a Spreadsheet: When Software Is Worth It"
excerpt: "A spreadsheet-versus-software decision guide for independent martial arts academies and multi-program dojos, with concrete fields, decision rules, and implementation steps."
...
A spreadsheet is often the right first implementation for martial arts trial student follow-up. It is cheap, editable, and forces the team to define the workflow. The question is not whether spreadsheets are good or bad; it is when coordination costs become larger than the flexibility is worth.
...
- One owner can reliably manage open the trial inquiry from a verified source.
