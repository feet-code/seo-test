---
title: "Common Martial Arts Belt Testing Eligibility Mistakes and How to Prevent Them"
...
Attendance, curriculum signoffs, instructor judgment, fees, equipment, and testing invitations are reconciled shortly before promotion events. The recurring failures are usually process-design problems rather than motivation problems. For independent martial arts academies and multi-program dojos, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the progression review

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every testing invitation reflects the school's recorded progression criteria and an explicit instructor decision When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open progression review needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct progression review identifier and source without asking the original owner?
