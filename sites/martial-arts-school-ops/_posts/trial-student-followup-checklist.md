---
title: "Martial Arts Trial Student Follow-Up Checklist for Independent Martial Arts Academies And Multi-Program Dojos"
excerpt: "A copyable quality-control checklist for independent martial arts academies and multi-program dojos, with concrete fields, decision rules, and implementation steps."
...
A checklist for martial arts trial student follow-up should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent martial arts academies and multi-program dojos and centers on one result: **every trial receives the promised, context-aware next step or a documented closed reason**.

## Before the work starts

- Confirm Trial Inquiry identifier and source
...
- Update Open the trial inquiry from a verified source
...
- Update Verify the outcome and close or reschedule the trial inquiry
...
- [ ] Review records where a new trial inquiry is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the trial inquiry
...
Choose one metric before the next cycle. Good options for this workflow are Trial Inquiry ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
