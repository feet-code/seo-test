---
title: "Auction Lot Intake And Catalog Readiness: A Practical Workflow"
...
Consignor authority, object identity, condition, estimate, reserve, photography, description, location, and sale assignment are reviewed in different tools. For independent auction houses and regional specialty auctioneers, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every published lot has complete authority, identity, commercial terms, location, and catalog approval**.
...
### 1. Open the auction lot from a verified source
