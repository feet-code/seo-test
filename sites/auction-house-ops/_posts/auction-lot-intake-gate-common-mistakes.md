---
title: "Common Auction Lot Intake And Catalog Readiness Mistakes and How to Prevent Them"
...
Consignor authority, object identity, condition, estimate, reserve, photography, description, location, and sale assignment are reviewed in different tools. The recurring failures are usually process-design problems rather than motivation problems. For independent auction houses and regional specialty auctioneers, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the auction lot

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every published lot has complete authority, identity, commercial terms, location, and catalog approval When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open auction lot needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct auction lot identifier and source without asking the original owner?
