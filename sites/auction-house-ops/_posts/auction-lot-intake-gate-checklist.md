---
title: "Auction Lot Intake And Catalog Readiness Checklist for Independent Auction Houses And Regional Specialty Auctioneers"
...
A checklist for auction lot intake and catalog readiness should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent auction houses and regional specialty auctioneers and centers on one result: **every published lot has complete authority, identity, commercial terms, location, and catalog approval**.

## Before the work starts

- Confirm Auction Lot identifier and source
...
- Update Open the auction lot from a verified source
...
- Update Verify the outcome and close or reschedule the auction lot
...
- [ ] Review records where a new auction lot is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the auction lot
...
Choose one metric before the next cycle. Good options for this workflow are Auction Lot ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
