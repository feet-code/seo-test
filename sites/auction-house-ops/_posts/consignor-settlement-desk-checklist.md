---
title: "Auction Consignor Settlement Reconciliation Checklist for Independent Auction Houses And Regional Specialty Auctioneers"
excerpt: "A copyable quality-control checklist for independent auction houses and regional specialty auctioneers, with concrete fields, decision rules, and implementation steps."
...
A checklist for auction consignor settlement reconciliation should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent auction houses and regional specialty auctioneers and centers on one result: **every consignor settlement has reconciled lot outcomes, contract terms, deductions, and payout approval**.

## Before the work starts

- Confirm Consignor Settlement identifier and source
...
- Update Open the consignor settlement from a verified source
...
- Update Verify the outcome and close or reschedule the consignor settlement
...
- [ ] Review records where a new consignor settlement is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the consignor settlement
...
Choose one metric before the next cycle. Good options for this workflow are Consignor Settlement ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
