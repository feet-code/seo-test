---
title: "Auction Consignor Settlement Reconciliation: A Practical Workflow"
...
Hammer results, unsold lots, commissions, fees, taxes, advances, returns, and payout details require sale-by-sale reconciliation. For independent auction houses and regional specialty auctioneers, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every consignor settlement has reconciled lot outcomes, contract terms, deductions, and payout approval**.
