---
title: "How to Measure Auction Lot Intake And Catalog Readiness: Practical Metrics"
...
Metrics for auction lot intake and catalog readiness should help independent auction houses and regional specialty auctioneers decide what to change next. Avoid universal benchmarks: volume, service model, and exception mix differ. Establish a baseline from your own records and compare the process against itself.
...
- If Auction Lot ready rate changes materially, use it to find where auction lot intake and catalog readiness repeatedly stalls.
