---
title: "Home Care Caregiver Visit Exception Checklist for Small Non-Medical Home-Care Agencies And Caregiver Coordination Teams"
...
- Update Open the visit exception from a verified source
...
- Update Verify the outcome and close or reschedule the visit exception
...
- [ ] Review records where a new visit exception is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the visit exception
...
Choose one metric before the next cycle. Good options for this workflow are Visit Exception ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
