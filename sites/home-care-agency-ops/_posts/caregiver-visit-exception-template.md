---
title: "Home Care Caregiver Visit Exception Template: Fields, Statuses, and Rules"
...
The most useful home care caregiver visit exception template is a small operating record. It should answer what is happening, who owns it, what evidence exists, and when the next decision occurs. This structure works in a spreadsheet, database, or focused application.
...
- A caregiver reports a transit delay
- A client declines part of a scheduled visit
- A replacement arrives but the original shift remains open
