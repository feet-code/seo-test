---
title: "How to Measure Landscape Enhancement Proposal Approval Tracking: Practical Metrics"
...
- If Observation-to-proposal time changes materially, use it to staff estimating handoff.
- If Proposal decision rate changes materially, use it to reduce limbo.
- If Approved-to-scheduled time changes materially, use it to align production capacity.
