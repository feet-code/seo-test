---
title: "Live Event Av Equipment Pack Verification Checklist for Small Live-Event Audio, Video, Lighting, And Staging Companies"
excerpt: "A copyable quality-control checklist for small live-event audio, video, lighting, and staging companies, with concrete fields, decision rules, and implementation steps."
...
A checklist for live event AV equipment pack verification should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for small live-event audio, video, lighting, and staging companies and centers on one result: **every deployed AV package is independently checked against the current show design and exception list**.

## Before the work starts

- Confirm Equipment Pack identifier and source
...
- Update Open the equipment pack from a verified source
...
- Update Verify the outcome and close or reschedule the equipment pack
...
- [ ] Review records where a new equipment pack is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the equipment pack
...
Choose one metric before the next cycle. Good options for this workflow are Equipment Pack ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
