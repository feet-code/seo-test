---
title: "Tax Preparation Missing Document Tracking Checklist for Independent Tax Preparers And Small Seasonal Tax Offices"
...
A checklist for tax preparation missing document tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent tax preparers and small seasonal tax offices and centers on one result: **every open client-document request has a specific item, reason, owner, due context, and resolved or closed outcome**.

## Before the work starts

- Confirm Client Document Request identifier and source
...
- Update Open the client document request from a verified source
...
- Update Verify the outcome and close or reschedule the client document request
...
- [ ] Review records where a new client document request is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the client document request
...
Choose one metric before the next cycle. Good options for this workflow are Client Document Request ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
