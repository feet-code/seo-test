---
title: "Common Tax Preparation Missing Document Tracking Mistakes and How to Prevent Them"
...
Organizer answers, source documents, explanations, follow-up questions, uploads, and stop conditions are tracked across portal tasks and email. The recurring failures are usually process-design problems rather than motivation problems. For independent tax preparers and small seasonal tax offices, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the client document request

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every open client-document request has a specific item, reason, owner, due context, and resolved or closed outcome When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open client document request needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct client document request identifier and source without asking the original owner?
