---
title: "Greenhouse Seasonal Crop Task Tracking Checklist for Independent Wholesale Nurseries And Greenhouse Growers"
...
A checklist for greenhouse seasonal crop task tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent wholesale nurseries and greenhouse growers and centers on one result: **every priority crop task has a current block, method, owner, due window, observation, and next decision**.

## Before the work starts

- Confirm Crop Work Item identifier and source
...
- Update Open the crop work item from a verified source
...
- Update Verify the outcome and close or reschedule the crop work item
...
- [ ] Review records where a new crop work item is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the crop work item
...
Choose one metric before the next cycle. Good options for this workflow are Crop Work Item ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
