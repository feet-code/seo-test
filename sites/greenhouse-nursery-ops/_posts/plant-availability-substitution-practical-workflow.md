---
title: "Nursery Plant Availability And Substitution Tracking: A Practical Workflow"
...
Crop counts, grade, size, bloom state, holds, losses, substitutions, and customer approvals change between order and pull. For independent wholesale nurseries and greenhouse growers, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every unavailable plant line reaches an approved substitute, adjusted date, partial, or documented cancellation**.
