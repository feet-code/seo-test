---
title: "Common Nursery Plant Availability And Substitution Tracking Mistakes and How to Prevent Them"
excerpt: "Process mistakes and guardrails for independent wholesale nurseries and greenhouse growers, with concrete fields, decision rules, and implementation steps."
...
Crop counts, grade, size, bloom state, holds, losses, substitutions, and customer approvals change between order and pull. The recurring failures are usually process-design problems rather than motivation problems. For independent wholesale nurseries and greenhouse growers, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the plant availability exception
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open plant availability exception needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct plant availability exception identifier and source without asking the original owner?
