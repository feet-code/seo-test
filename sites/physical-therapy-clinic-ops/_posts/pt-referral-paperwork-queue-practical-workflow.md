---
title: "Physical Therapy Referral And Authorization Paperwork: A Practical Workflow"
...
Referral orders, payer steps, demographics, prior records, scheduling, and patient outreach mature separately before the first visit. For independent physical therapy clinics and small rehabilitation practices, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every scheduled evaluation has its clinic-defined administrative prerequisites complete or an owned exception**.
