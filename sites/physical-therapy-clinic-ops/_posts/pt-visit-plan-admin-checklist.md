---
title: "Physical Therapy Visit Plan Administration Checklist for Independent Physical Therapy Clinics And Small Rehabilitation Practices"
excerpt: "A copyable quality-control checklist for independent physical therapy clinics and small rehabilitation practices, with concrete fields, decision rules, and implementation steps."
...
A checklist for physical therapy visit plan administration should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent physical therapy clinics and small rehabilitation practices and centers on one result: **every administrative visit-plan exception has a current count, owner, and documented scheduling or payer next step**.

## Before the work starts

- Confirm Visit-Plan Record identifier and source
...
- Update Open the visit-plan record from a verified source
...
- Update Verify the outcome and close or reschedule the visit-plan record
...
- [ ] Review records where a new visit-plan record is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the visit-plan record
...
Choose one metric before the next cycle. Good options for this workflow are Visit-Plan Record ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
