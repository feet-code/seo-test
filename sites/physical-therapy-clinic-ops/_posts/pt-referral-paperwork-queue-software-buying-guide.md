---
title: "Physical Therapy Referral And Authorization Paperwork Software Buying Guide"
...
Software for physical therapy referral and authorization paperwork should be evaluated against the operating problem, not a generic feature checklist. For independent physical therapy clinics and small rehabilitation practices, a useful trial must demonstrate this outcome: **every scheduled evaluation has its clinic-defined administrative prerequisites complete or an owned exception**.

## Write requirements from the workflow

The tool must support these steps without hidden spreadsheets: Open the referral record from a verified source, Collect the required inputs and operating evidence, Validate readiness and classify material exceptions, Assign the next action and communicate the decision, Verify the outcome and close or reschedule the referral record. It must also make these fields easy to capture at the moment work happens: Referral Record identifier and source, Customer account site or operating location, Current status version and last change, Required input evidence and received time, Exception category impact and decision boundary, Owner next action and responsible reviewer, Due window escalation time and communication state, Verified outcome closed reason and audit note.

## Use a live demo script

Ask the vendor—or your internal prototype—to complete these tasks:

- Create and resolve this test case: A referral omits a required provider detail
- Create and resolve this test case: Authorization is pending near the appointment
- Create and resolve this test case: The patient sends records to the wrong location
...
|---|---|---|
| Referral Record ready rate | referral records completed with required evidence / referral records due | find where physical therapy referral and authorization paperwork repeatedly stalls |
...
- Treating a message or scheduled task as completion of the referral record
