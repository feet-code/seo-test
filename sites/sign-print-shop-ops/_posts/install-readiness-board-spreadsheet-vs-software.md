---
title: "Install Readiness Board vs. a Spreadsheet: When Software Is Worth It"
...
A spreadsheet is often the right first implementation for sign installation readiness tracking. It is cheap, editable, and forces the team to define the workflow. The question is not whether spreadsheets are good or bad; it is when coordination costs become larger than the flexibility is worth.
...
- One owner can reliably manage open install readiness from the approved job.
- One owner can reliably manage verify fabrication, packaging, and hardware.
- One owner can reliably manage confirm site survey, permit, access, and customer window.
...
Before migrating, recreate ten current records using the candidate tool. Confirm that it supports these fields without awkward workarounds: Customer, job, and site, Approved proof and fabricated items, Survey dimensions and mounting condition, Permit or landlord approval, Access contact and install window, Crew skills and assignments, Vehicle, lift, tools, and hardware, Weather decision and dispatch release. Then walk one exception from start to finish. Test exports and deletion before importing the full history.
