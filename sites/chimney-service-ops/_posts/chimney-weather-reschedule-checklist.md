---
title: "Chimney Service Weather Rescheduling Checklist for Independent Chimney Sweep, Inspection, And Fireplace-Service Companies"
...
- Update Open the weather exception from a verified source
...
- Update Verify the outcome and close or reschedule the weather exception
...
- [ ] Review records where a new weather exception is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the weather exception
...
Choose one metric before the next cycle. Good options for this workflow are Weather Exception ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
