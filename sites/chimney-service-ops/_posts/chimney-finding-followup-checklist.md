---
title: "Chimney Inspection Finding Follow-Up Checklist for Independent Chimney Sweep, Inspection, And Fireplace-Service Companies"
excerpt: "A copyable quality-control checklist for independent chimney sweep, inspection, and fireplace-service companies, with concrete fields, decision rules, and implementation steps."
...
A checklist for chimney inspection finding follow-up should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent chimney sweep, inspection, and fireplace-service companies and centers on one result: **every material finding reaches a documented customer decision and an owned next action**.

## Before the work starts

- Confirm Inspection Finding identifier and source
...
- Update Open the inspection finding from a verified source
...
- Update Verify the outcome and close or reschedule the inspection finding
...
- [ ] Review records where a new inspection finding is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the inspection finding
...
Choose one metric before the next cycle. Good options for this workflow are Inspection Finding ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
