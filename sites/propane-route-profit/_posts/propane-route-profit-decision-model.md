---
title: "Propane Delivery Route Profitability and Forecasting Calculator: Inputs, Formula, and Decisions"
excerpt: "A practical decision model for propane route profitability, including inputs, calculations, and actions."
...
Low-volume and premature deliveries consume route capacity while account economics remain hidden. A useful calculation for propane delivery route profitability and forecasting should help independent propane delivery companies make a specific capacity decision and produce this outcome: **Ranks deliveries by service risk and contribution, and exposes accounts that need minimums or repricing**.

The product hypothesis is: Combines gallons, tank telemetry or forecasts, route miles, stop time, driver cost, and customer price to prioritize profitable deliveries. The model should expose its assumptions and compare the eventual result with the forecast. Avoid universal benchmarks because volume, service model, cost structure, and exception mix differ. Establish a baseline from the buyer's own records and compare the decision process against itself.

## Start with the economic question

Delivery decisions recur daily, fuel volume supports pricing, and operational history creates a data advantage. Write that question at the top of the model. If an input cannot change the recommendation or explain the result, keep it out of the first version.
