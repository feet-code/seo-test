---
title: "Meal Prep Menu And Allergen Information Change Tracking: A Practical Workflow"
excerpt: "A step-by-step operating workflow for independent prepared-meal subscription kitchens, with concrete fields, decision rules, and implementation steps."
...
Recipe, ingredient, supplier, label, menu copy, allergen information, nutrition source, and production instructions can change on different schedules. For independent prepared-meal subscription kitchens, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every published menu change has reviewed source information, effective batches, labels, and production acknowledgment**.
...
- a new menu change is created or its due window changes
