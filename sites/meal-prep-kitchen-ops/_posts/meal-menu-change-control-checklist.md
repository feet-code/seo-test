---
title: "Meal Prep Menu And Allergen Information Change Tracking Checklist for Independent Prepared-Meal Subscription Kitchens"
...
A checklist for meal prep menu and allergen information change tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent prepared-meal subscription kitchens and centers on one result: **every published menu change has reviewed source information, effective batches, labels, and production acknowledgment**.

## Before the work starts

- Confirm Menu Change identifier and source
...
- Update Open the menu change from a verified source
...
- Update Verify the outcome and close or reschedule the menu change
...
- [ ] Review records where a new menu change is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the menu change
...
Choose one metric before the next cycle. Good options for this workflow are Menu Change ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
