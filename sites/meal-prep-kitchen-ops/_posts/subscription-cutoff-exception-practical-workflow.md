---
title: "Meal Prep Subscription Skip And Change Cutoff: A Practical Workflow"
...
Skips, swaps, pauses, address changes, payment issues, production counts, and delivery routes are handled after automated cutoffs through support messages. For independent prepared-meal subscription kitchens, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every post-cutoff request receives a feasible production, billing, route, and customer outcome**.
...
### 1. Open the subscription exception from a verified source
