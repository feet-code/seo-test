---
title: "Makeup Session Coordinator vs. a Spreadsheet: When Software Is Worth It"
...
A spreadsheet is often the right first implementation for tutoring makeup session scheduling. It is cheap, editable, and forces the team to define the workflow. The question is not whether spreadsheets are good or bad; it is when coordination costs become larger than the flexibility is worth.
...
- One owner can reliably manage record the canceled session and policy reason.
- One owner can reliably manage determine makeup or credit eligibility.
- One owner can reliably manage offer compatible tutor and student times.
