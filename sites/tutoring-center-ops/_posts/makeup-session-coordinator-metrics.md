---
title: "How to Measure Tutoring Makeup Session Scheduling: Practical Metrics"
...
- If Makeup resolution time changes materially, use it to adjust options and parent cadence.
- If Credit aging changes materially, use it to prioritize expiring obligations.
- If Reconciliation error rate changes materially, use it to fix system handoffs.
