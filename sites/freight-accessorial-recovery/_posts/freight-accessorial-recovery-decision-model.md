---
title: "Freight Accessorial Charge Recovery and Unbilled Revenue Calculator: Inputs, Formula, and Decisions"
excerpt: "A practical decision model for freight accessorial charge recovery and unbilled revenue calculator, including inputs, calculations, and actions."
...
Accessorial revenue is lost when events, documents, carrier invoices, and customer billing live in different systems. A useful calculation for freight accessorial charge recovery and unbilled revenue should help small freight brokers and regional 3PLs make a specific revenue-capture decision and produce this outcome: **Matches operational evidence to billable rules and produces a reviewable recovery queue before invoicing closes**.

The product hypothesis is: Detects detention, layover, TONU, lumper, and redelivery charges that have evidence but were never billed. The model should expose its assumptions and compare the eventual result with the forecast. Avoid universal benchmarks because volume, service model, cost structure, and exception mix differ. Establish a baseline from the buyer's own records and compare the decision process against itself.

## Start with the economic question

One recovered charge can cover the subscription, while repeated shipment volume creates retention and usage expansion. Write that question at the top of the model. If an input cannot change the recommendation or explain the result, keep it out of the first version.
