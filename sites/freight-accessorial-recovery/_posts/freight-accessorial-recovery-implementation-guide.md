---
title: "How to Improve Freight Accessorial Charge Recovery and Unbilled Revenue: A Practical Implementation Guide"
excerpt: "A step-by-step implementation guide for unbilled detention charge recovery, with fields, rules, and exceptions."
...
Accessorial revenue is lost when events, documents, carrier invoices, and customer billing live in different systems. For small freight brokers and regional 3PLs, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **Matches operational evidence to billable rules and produces a reviewable recovery queue before invoicing closes**.

The narrow product hypothesis is: Detects detention, layover, TONU, lumper, and redelivery charges that have evidence but were never billed. Keep the first implementation focused on the named economic decision rather than expanding it into a general operations suite.
...
### 1. Collect the minimum source records needed to evaluate freight accessorial charge recovery and unbilled revenue.
