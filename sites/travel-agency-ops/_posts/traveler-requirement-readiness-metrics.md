---
title: "How to Measure Travel Document Requirement Readiness Tracking: Practical Metrics"
...
- If Ready-by-cutoff rate changes materially, use it to time traveler communications.
- If Exception resolution time changes materially, use it to assign agency coverage.
- If Reminder-to-completion rate changes materially, use it to improve clarity and cadence.
