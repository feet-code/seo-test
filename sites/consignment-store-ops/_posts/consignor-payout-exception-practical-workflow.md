---
title: "Consignment Store Payout Reconciliation: A Practical Workflow"
excerpt: "A step-by-step operating workflow for independent apparel, furniture, and specialty consignment stores, with concrete fields, decision rules, and implementation steps."
...
Sale returns, discounts, fees, account details, holds, payout method, and unclaimed balances create recurring consignor questions. For independent apparel, furniture, and specialty consignment stores, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every payout exception is reconciled to item events and ends in an approved payment or documented hold**.
