---
title: "How to Measure Consignment Inventory Aging And Markdown Tracking: Practical Metrics"
excerpt: "Definitions and calculations for useful metrics for independent apparel, furniture, and specialty consignment stores, with concrete fields, decision rules, and implementation steps."
...
- If Aging Item ready rate changes materially, use it to find where consignment inventory aging and markdown tracking repeatedly stalls.
