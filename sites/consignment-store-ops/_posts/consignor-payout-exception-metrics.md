---
title: "How to Measure Consignment Store Payout Reconciliation: Practical Metrics"
...
- If Payout Exception ready rate changes materially, use it to find where consignment store payout reconciliation repeatedly stalls.
