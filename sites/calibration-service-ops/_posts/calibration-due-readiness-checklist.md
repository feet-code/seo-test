---
title: "Calibration Asset Due And Access Tracking Checklist for Independent Calibration Laboratories And Mobile Metrology Service Teams"
...
A checklist for calibration asset due and access tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent calibration laboratories and mobile metrology service teams and centers on one result: **every due asset has verified identity, location, scope, access, timing, and service disposition**.

## Before the work starts

- Confirm Calibration Asset identifier and source
...
- Update Open the calibration asset from a verified source
...
- Update Verify the outcome and close or reschedule the calibration asset
...
- [ ] Review records where a new calibration asset is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the calibration asset
...
Choose one metric before the next cycle. Good options for this workflow are Calibration Asset ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
