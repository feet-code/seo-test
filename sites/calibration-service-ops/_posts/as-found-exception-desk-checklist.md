---
title: "Calibration As-Found Exception Tracking Checklist for Independent Calibration Laboratories And Mobile Metrology Service Teams"
...
- Update Open the as-found exception from a verified source
...
- Update Verify the outcome and close or reschedule the as-found exception
...
- [ ] Review records where a new as-found exception is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the as-found exception
...
Choose one metric before the next cycle. Good options for this workflow are As-Found Exception ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
