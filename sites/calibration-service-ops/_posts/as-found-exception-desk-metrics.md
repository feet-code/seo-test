---
title: "How to Measure Calibration As-Found Exception Tracking: Practical Metrics"
...
- If As-Found Exception ready rate changes materially, use it to find where calibration as-found exception tracking repeatedly stalls.
