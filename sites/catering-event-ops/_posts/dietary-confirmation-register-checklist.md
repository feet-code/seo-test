---
title: "Catering Dietary And Allergen Confirmation Checklist for Independent Caterers And Small Event-Food Teams"
...
- [ ] Review records where a request is ambiguous or missing a guest count
- [ ] Review records where the requested accommodation conflicts with menu or facility controls
- [ ] Review records where a new requirement arrives after the production cutoff

- [ ] Check for inferring allergy severity from a preference label
- [ ] Check for promising an accommodation before kitchen review
- [ ] Check for updating a spreadsheet but not the final event order
- [ ] Check for exposing guest health details beyond the staff who need them
