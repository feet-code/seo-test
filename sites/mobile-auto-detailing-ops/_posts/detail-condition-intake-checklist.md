---
title: "Vehicle Detailing Condition And Service Authorization Checklist for Independent Mobile Detailers And Small Multi-Van Detailing Teams"
...
- Update Open the vehicle intake from a verified source
...
- Update Verify the outcome and close or reschedule the vehicle intake
...
- [ ] Review records where a new vehicle intake is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the vehicle intake
...
Choose one metric before the next cycle. Good options for this workflow are Vehicle Intake ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
