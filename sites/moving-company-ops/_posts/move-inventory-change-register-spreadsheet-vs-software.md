---
title: "Move Inventory Change Register vs. a Spreadsheet: When Software Is Worth It"
...
A spreadsheet is often the right first implementation for moving inventory change authorization. It is cheap, editable, and forces the team to define the workflow. The question is not whether spreadsheets are good or bad; it is when coordination costs become larger than the flexibility is worth.
...
- One owner can reliably manage log the requested or observed scope change.
- One owner can reliably manage compare it with the approved estimate and inventory.
- One owner can reliably manage assess labor, equipment, timing, and price impact.
