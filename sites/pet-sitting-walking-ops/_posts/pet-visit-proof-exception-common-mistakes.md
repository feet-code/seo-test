---
title: "Common Pet Sitting Visit Evidence Exception Mistakes and How to Prevent Them"
excerpt: "Process mistakes and guardrails for independent pet-sitting and dog-walking companies, with concrete fields, decision rules, and implementation steps."
...
Scheduled visits, arrival evidence, task notes, pet observations, client messages, and coverage changes can conflict during route disruptions. The recurring failures are usually process-design problems rather than motivation problems. For independent pet-sitting and dog-walking companies, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the visit exception

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every questionable or missed visit is investigated, recovered, communicated, and closed with evidence When the exception occurs, keep it visible instead of repairing it privately in email.
