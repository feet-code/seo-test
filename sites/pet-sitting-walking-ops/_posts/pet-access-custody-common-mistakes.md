---
title: "Common Pet Sitting Key And Access Custody Mistakes and How to Prevent Them"
...
Keys, lockbox codes, fobs, alarm instructions, pickup, assignment, return, and access changes are tracked in messages and labels. The recurring failures are usually process-design problems rather than motivation problems. For independent pet-sitting and dog-walking companies, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the access item

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every physical or digital access item has limited visibility, an accountable custodian, and a verified return or revocation When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open access item needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct access item identifier and source without asking the original owner?
