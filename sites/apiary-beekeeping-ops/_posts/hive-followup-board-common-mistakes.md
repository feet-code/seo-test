---
title: "Common Apiary Inspection Follow-Up Tracking Mistakes and How to Prevent Them"
...
Inspection observations, queen status, food stores, equipment needs, planned actions, yard access, and revisit timing are kept in notes that do not become a work queue. The recurring failures are usually process-design problems rather than motivation problems. For commercial and sideline beekeepers managing multiple apiary locations, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the hive follow-up

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every material hive observation has an appropriate action, owner, timing, and verified follow-up When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open hive follow-up needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct hive follow-up identifier and source without asking the original owner?
