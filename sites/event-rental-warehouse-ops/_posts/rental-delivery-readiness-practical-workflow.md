---
title: "Event Rental Delivery Site Readiness: A Practical Workflow"
...
Access windows, surfaces, elevators, placement plans, contacts, labor, weather, permits, and pickup constraints change after dispatch planning. For independent event-furniture, tent, linen, and party-rental companies, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every delivery stop has current site, contact, timing, placement, labor, and exception instructions**.
...
### 1. Open the delivery stop from a verified source
...
- a new delivery stop is created or its due window changes
