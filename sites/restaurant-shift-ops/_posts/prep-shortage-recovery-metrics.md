---
title: "How to Measure Restaurant Prep Shortage Tracking: Practical Metrics"
...
The calculations only work if the operating record consistently includes Location, shift, and station, Prep item and unit, Par, on-hand, and expected demand, Affected menu items, Shortage cause, Approved recovery action, Owner and ready-by time, Verified quantity and communication. Define when the clock starts and stops. Decide whether paused or waiting time remains inside cycle time, and keep that rule stable across the comparison period.
...
- If Recovery cycle time changes materially, use it to set escalation thresholds.
- If Shortage frequency changes materially, use it to change pars or prep ownership.
- If Recovered-before-impact rate changes materially, use it to improve pre-shift checks.
