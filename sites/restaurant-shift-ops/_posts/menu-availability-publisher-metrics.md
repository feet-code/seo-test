---
title: "How to Measure Restaurant 86 List And Menu Availability Tracking: Practical Metrics"
...
The calculations only work if the operating record consistently includes Location and shift, Menu item or modifier, Reason and remaining quantity, Unavailable-from and expected return, Affected channels, Approved alternative or message, Publisher and verification evidence, Reactivation owner and time. Define when the clock starts and stops. Decide whether paused or waiting time remains inside cycle time, and keep that rule stable across the comparison period.
...
- If Availability correction rate changes materially, use it to improve verification.
- If Guest-impact orders changes materially, use it to test channel propagation.
