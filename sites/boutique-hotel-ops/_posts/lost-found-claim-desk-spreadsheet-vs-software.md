---
title: "Lost and Found Claim Desk vs. a Spreadsheet: When Software Is Worth It"
excerpt: "A spreadsheet-versus-software decision guide for independent boutique hotels and small hospitality teams, with concrete fields, decision rules, and implementation steps."
...
A spreadsheet is often the right first implementation for hotel lost and found claim tracking. It is cheap, editable, and forces the team to define the workflow. The question is not whether spreadsheets are good or bad; it is when coordination costs become larger than the flexibility is worth.
...
- One owner can reliably manage register the found item without exposing identifying detail.
- One owner can reliably manage record the guest claim and verification answers.
- One owner can reliably manage match claims to inventory under controlled review.
...
Before migrating, recreate ten current records using the candidate tool. Confirm that it supports these fields without awkward workarounds: Hotel, room area, and found time, Item category and nonpublic identifiers, Finder and custody events, Storage location, Claimant and stay reference, Verification questions and match decision, Pickup or shipping authorization, Release recipient or policy disposition. Then walk one exception from start to finish. Test exports and deletion before importing the full history.
