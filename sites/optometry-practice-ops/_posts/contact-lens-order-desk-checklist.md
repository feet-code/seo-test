---
title: "Optometry Contact Lens Order Tracking Checklist for Independent Optometry Practices And Optical Dispensaries"
excerpt: "A copyable quality-control checklist for independent optometry practices and optical dispensaries, with concrete fields, decision rules, and implementation steps."
...
A checklist for optometry contact lens order tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent optometry practices and optical dispensaries and centers on one result: **every contact-lens order moves from authorized specification to received, notified, and collected or closed**.

## Before the work starts

- Confirm Contact-Lens Order identifier and source
...
- Update Open the contact-lens order from a verified source
...
- Update Verify the outcome and close or reschedule the contact-lens order
...
- [ ] Review records where a new contact-lens order is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the contact-lens order
...
Choose one metric before the next cycle. Good options for this workflow are Contact-Lens Order ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
