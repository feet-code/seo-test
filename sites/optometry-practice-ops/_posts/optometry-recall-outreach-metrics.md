---
title: "How to Measure Optometry Patient Recall Outreach: Practical Metrics"
...
Metrics for optometry patient recall outreach should help independent optometry practices and optical dispensaries decide what to change next. Avoid universal benchmarks: volume, service model, and exception mix differ. Establish a baseline from your own records and compare the process against itself.
...
- If Recall Record ready rate changes materially, use it to find where optometry patient recall outreach repeatedly stalls.
