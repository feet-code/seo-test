---
title: "Pool Repair Approval Queue vs. a Spreadsheet: When Software Is Worth It"
...
A spreadsheet is often the right first implementation for pool service repair estimate approval tracking. It is cheap, editable, and forces the team to define the workflow. The question is not whether spreadsheets are good or bad; it is when coordination costs become larger than the flexibility is worth.
...
- One owner can reliably manage open a repair finding from the service stop.
- One owner can reliably manage confirm equipment identity and diagnosis evidence.
- One owner can reliably manage build options scope and price.
