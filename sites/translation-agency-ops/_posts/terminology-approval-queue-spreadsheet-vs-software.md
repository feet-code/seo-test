---
title: "Terminology Approval Queue vs. a Spreadsheet: When Software Is Worth It"
excerpt: "A spreadsheet-versus-software decision guide for boutique translation agencies and localization project teams, with concrete fields, decision rules, and implementation steps."
...
A spreadsheet is often the right first implementation for translation terminology approval workflow. It is cheap, editable, and forces the team to define the workflow. The question is not whether spreadsheets are good or bad; it is when coordination costs become larger than the flexibility is worth.
...
- One owner can reliably manage open the source term with context.
- One owner can reliably manage propose target terms and rationale.
- One owner can reliably manage route to the authorized reviewer.
...
Before migrating, recreate ten current records using the candidate tool. Confirm that it supports these fields without awkward workarounds: Client, project, and language pair, Source term and context, Screenshot or segment reference, Proposed target terms, Owner and authorized approver, Needed-by date and work impact, Approved decision and rationale, Glossary version and affected-job update. Then walk one exception from start to finish. Test exports and deletion before importing the full history.
