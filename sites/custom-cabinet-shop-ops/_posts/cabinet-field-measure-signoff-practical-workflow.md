---
title: "Custom Cabinet Field Measurement Approval: A Practical Workflow"
...
Plans, site conditions, appliance specifications, walls, utilities, openings, tolerances, customer changes, and production release can diverge after measure. For independent custom cabinetmakers and small millwork installation teams, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every cabinet job enters production from a reviewed field record and explicit design or customer sign-off**.
...
- a new field measurement record is created or its due window changes
