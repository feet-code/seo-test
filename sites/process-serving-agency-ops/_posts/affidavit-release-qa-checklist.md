---
title: "Process Service Affidavit Quality Control Checklist for Independent Process-Serving Agencies And Small Field-Server Teams"
excerpt: "A copyable quality-control checklist for independent process-serving agencies and small field-server teams, with concrete fields, decision rules, and implementation steps."
...
A checklist for process service affidavit quality control should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent process-serving agencies and small field-server teams and centers on one result: **every released affidavit matches the field record and client-defined completeness checks with a review trail**.

## Before the work starts

- Confirm Service Affidavit identifier and source
...
- Update Open the service affidavit from a verified source
...
- Update Verify the outcome and close or reschedule the service affidavit
...
- [ ] Review records where a new service affidavit is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the service affidavit
...
Choose one metric before the next cycle. Good options for this workflow are Service Affidavit ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
