---
title: "How to Measure Environmental Chain Of Custody Exception Tracking: Practical Metrics"
...
The calculations only work if the operating record consistently includes Project event shipment and cooler, Sample IDs containers and requested analyses, Collector transfer receiver and timestamps, Seal condition temperature and preservation, Original custody form and label images, Discrepancy type affected samples and impact, Qualified reviewer disposition and rationale, Laboratory status correction link and notification. Define when the clock starts and stops. Decide whether paused or waiting time remains inside cycle time, and keep that rule stable across the comparison period.
...
- If Exception detection time changes materially, use it to improve intake.
- If Qualified decision time changes materially, use it to protect hold times.
- If Repeat discrepancy rate changes materially, use it to target training and forms.
