---
title: "School Transportation Substitute Driver Readiness Checklist for Small School-Bus Contractors And Private Student-Transportation Operators"
excerpt: "A copyable quality-control checklist for small school-bus contractors and private student-transportation operators, with concrete fields, decision rules, and implementation steps."
...
A checklist for school transportation substitute driver readiness should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for small school-bus contractors and private student-transportation operators and centers on one result: **every substitute assignment is released with the current route packet, vehicle access, and dispatcher acknowledgment**.

## Before the work starts

- Confirm Substitute Assignment identifier and source
...
- Update Open the substitute assignment from a verified source
...
- Update Verify the outcome and close or reschedule the substitute assignment
...
- [ ] Review records where a new substitute assignment is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the substitute assignment
...
Choose one metric before the next cycle. Good options for this workflow are Substitute Assignment ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
