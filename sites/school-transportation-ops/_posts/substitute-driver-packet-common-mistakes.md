---
title: "Common School Transportation Substitute Driver Readiness Mistakes and How to Prevent Them"
...
Route directions, vehicle, student notes, contacts, schedule variations, keys, and check-in expectations are assembled at the last minute. The recurring failures are usually process-design problems rather than motivation problems. For small school-bus contractors and private student-transportation operators, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the substitute assignment

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every substitute assignment is released with the current route packet, vehicle access, and dispatcher acknowledgment When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open substitute assignment needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct substitute assignment identifier and source without asking the original owner?
