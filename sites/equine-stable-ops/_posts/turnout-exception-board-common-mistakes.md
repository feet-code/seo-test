---
title: "Common Horse Turnout And Blanketing Exception Tracking Mistakes and How to Prevent Them"
...
Weather, footing, herd compatibility, horse condition, equipment, and owner instructions change faster than whiteboards and group messages. The recurring failures are usually process-design problems rather than motivation problems. For independent boarding stables and small equestrian facilities, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the daily care exception

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every daily turnout exception is visible to all affected shifts with an owner and next review When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open daily care exception needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct daily care exception identifier and source without asking the original owner?
