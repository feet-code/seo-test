---
title: "Swim School Makeup Lesson Credit Tracking: A Practical Workflow"
excerpt: "A step-by-step operating workflow for independent swim schools and lesson programs, with concrete fields, decision rules, and implementation steps."
...
Absence reasons, policy eligibility, credit expiry, class capacity, redemption, and cancellations are reconciled through front-desk messages. For independent swim schools and lesson programs, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every make-up request has a consistent eligibility decision and a traceable credit outcome**.
...
- a new make-up credit is created or its due window changes
