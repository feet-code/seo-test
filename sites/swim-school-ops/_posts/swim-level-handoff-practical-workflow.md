---
title: "Swim Lesson Level Progression Tracking: A Practical Workflow"
...
Skill observations, confidence, instructor notes, class placement, and parent communication can diverge when students change instructors or terms. For independent swim schools and lesson programs, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every level change has current observations, an instructor decision, and a communicated next placement**.
...
- a new level review is created or its due window changes
