---
title: "Common Swim Lesson Level Progression Tracking Mistakes and How to Prevent Them"
...
Skill observations, confidence, instructor notes, class placement, and parent communication can diverge when students change instructors or terms. The recurring failures are usually process-design problems rather than motivation problems. For independent swim schools and lesson programs, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the level review

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every level change has current observations, an instructor decision, and a communicated next placement When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open level review needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct level review identifier and source without asking the original owner?
