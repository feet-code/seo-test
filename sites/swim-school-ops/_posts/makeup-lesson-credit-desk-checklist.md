---
title: "Swim School Makeup Lesson Credit Tracking Checklist for Independent Swim Schools And Lesson Programs"
excerpt: "A copyable quality-control checklist for independent swim schools and lesson programs, with concrete fields, decision rules, and implementation steps."
...
A checklist for swim school makeup lesson credit tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent swim schools and lesson programs and centers on one result: **every make-up request has a consistent eligibility decision and a traceable credit outcome**.

## Before the work starts

- Confirm Make-Up Credit identifier and source
...
- Update Open the make-up credit from a verified source
...
- Update Verify the outcome and close or reschedule the make-up credit
...
- [ ] Review records where a new make-up credit is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the make-up credit
...
Choose one metric before the next cycle. Good options for this workflow are Make-Up Credit ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
