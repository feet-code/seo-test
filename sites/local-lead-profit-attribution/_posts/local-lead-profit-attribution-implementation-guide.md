---
title: "How to Improve Home Service Lead Source Profitability Attribution: A Practical Implementation Guide"
excerpt: "A step-by-step implementation guide for contractor advertising profit attribution, with fields, rules, and exceptions."
...
Marketing channels are judged by leads or booked revenue even when they produce low-margin jobs, poor geography, or capacity strain. For multi-crew home-service businesses, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **Shows contribution profit by source and service so the owner can reallocate spend with evidence**.

The narrow product hypothesis is: Connects lead source to booked work, technician capacity, job gross profit, callback, and repeat revenue instead of revenue alone. Keep the first implementation focused on the named economic decision rather than expanding it into a general operations suite.
...
### 1. Collect the minimum source records needed to evaluate home service lead source profitability attribution.
