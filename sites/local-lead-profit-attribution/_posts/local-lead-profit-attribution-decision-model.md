---
title: "Home Service Lead Source Profitability Attribution Calculator: Inputs, Formula, and Decisions"
excerpt: "A practical decision model for lead source job profitability, including inputs, calculations, and actions."
...
Marketing channels are judged by leads or booked revenue even when they produce low-margin jobs, poor geography, or capacity strain. A useful calculation for home service lead source profitability attribution should help multi-crew home-service businesses make a specific margin decision and produce this outcome: **Shows contribution profit by source and service so the owner can reallocate spend with evidence**.

The product hypothesis is: Connects lead source to booked work, technician capacity, job gross profit, callback, and repeat revenue instead of revenue alone. The model should expose its assumptions and compare the eventual result with the forecast. Avoid universal benchmarks because volume, service model, cost structure, and exception mix differ. Establish a baseline from the buyer's own records and compare the decision process against itself.

## Start with the economic question

The product controls recurring marketing spend and can prove value through budget reallocation. Write that question at the top of the model. If an input cannot change the recommendation or explain the result, keep it out of the first version.
