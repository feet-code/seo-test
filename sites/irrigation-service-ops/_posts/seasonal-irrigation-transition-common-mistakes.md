---
title: "Common Irrigation Startup And Winterization Tracking Mistakes and How to Prevent Them"
...
Startup and winterization work spans access, controller state, backflow or supply status, zone checks, repairs, and customer decisions across many properties. The recurring failures are usually process-design problems rather than motivation problems. For independent irrigation maintenance and repair companies, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the seasonal service transition

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every seasonal transition is completed, exceptioned, or rescheduled with property-specific evidence When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open seasonal service transition needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct seasonal service transition identifier and source without asking the original owner?
