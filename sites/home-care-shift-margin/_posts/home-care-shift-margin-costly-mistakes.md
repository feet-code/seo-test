---
title: "Non-medical Home Care Shift and Client Profitability: Costly Mistakes and How to Catch Them"
excerpt: "The recurring mistakes that undermine non-medical home care shift and client profitability, plus concrete controls and review questions."
...
Agencies accept schedules whose travel and overtime patterns erase the apparent bill-pay spread. The recurring failures are usually process-design problems rather than motivation problems. For non-medical home-care agencies, these are the mistakes worth finding before buying or building software. The central risk to validate is **Wage rules vary, health-related data raises security expectations, and scheduling vendors may compete.**.
