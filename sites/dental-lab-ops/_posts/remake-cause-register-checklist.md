---
title: "Dental Laboratory Remake Cause Tracking Checklist for Independent Dental Laboratories Serving Local Dental Practices"
...
- [ ] Review records where a practice requests correction replacement or remake
- [ ] Review records where returned evidence conflicts with the original record
- [ ] Review records where review identifies a repeated preventable failure mode

- [ ] Check for assigning blame before evidence review
- [ ] Check for using other as the default cause
- [ ] Check for losing the original version after opening replacement work
- [ ] Check for counting the remake closed when production begins
