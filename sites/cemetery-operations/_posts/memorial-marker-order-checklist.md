---
title: "Cemetery Memorial Marker Order And Installation Checklist for Independent Cemeteries And Small Memorial-Park Teams"
excerpt: "A copyable quality-control checklist for independent cemeteries and small memorial-park teams, with concrete fields, decision rules, and implementation steps."
...
A checklist for cemetery memorial marker order and installation should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent cemeteries and small memorial-park teams and centers on one result: **every marker order has an approved specification, compliant placement, tracked production, and verified installation**.

## Before the work starts

- Confirm Marker Order identifier and source
...
- Update Open the marker order from a verified source
...
- Update Verify the outcome and close or reschedule the marker order
...
- [ ] Review records where a new marker order is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the marker order
...
Choose one metric before the next cycle. Good options for this workflow are Marker Order ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
