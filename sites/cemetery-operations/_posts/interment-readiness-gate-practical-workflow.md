---
title: "Cemetery Interment Readiness Tracking: A Practical Workflow"
excerpt: "A step-by-step operating workflow for independent cemeteries and small memorial-park teams, with concrete fields, decision rules, and implementation steps."
...
Authorization, ownership, location, permits, schedule, opening, funeral-home coordination, equipment, family requests, and closeout require exact handoffs. For independent cemeteries and small memorial-park teams, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every interment is released only after the cemetery's authority, location, scheduling, coordination, and site checks are complete**.
...
- a new interment case is created or its due window changes
