---
title: "Cemetery Interment Readiness Tracking Checklist for Independent Cemeteries And Small Memorial-Park Teams"
...
- Update Open the interment case from a verified source
...
- Update Verify the outcome and close or reschedule the interment case
...
- [ ] Review records where a new interment case is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the interment case
...
Choose one metric before the next cycle. Good options for this workflow are Interment Case ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
