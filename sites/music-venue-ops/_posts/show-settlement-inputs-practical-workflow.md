---
title: "Music Venue Show Settlement Reconciliation: A Practical Workflow"
...
Ticket counts, comps, fees, expenses, merchandise, guarantees, deposits, and approvals arrive from multiple systems after the show. For independent music venues, clubs, and small concert halls, the useful goal is not to add another dashboard. It is to create a small, visible process that produces this outcome: **every show settlement is built from reconciled inputs with documented variances and approval**.
...
- a new settlement input is created or its due window changes
