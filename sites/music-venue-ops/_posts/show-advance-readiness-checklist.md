---
title: "Music Venue Show Advancing Checklist for Independent Music Venues, Clubs, And Small Concert Halls"
excerpt: "A copyable quality-control checklist for independent music venues, clubs, and small concert halls, with concrete fields, decision rules, and implementation steps."
...
A checklist for music venue show advancing should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for independent music venues, clubs, and small concert halls and centers on one result: **every show reaches event day with required advance decisions owned, versioned, and communicated**.

## Before the work starts

- Confirm Show Advance identifier and source
...
- Update Open the show advance from a verified source
...
- Update Verify the outcome and close or reschedule the show advance
...
- [ ] Review records where a new show advance is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the show advance
...
Choose one metric before the next cycle. Good options for this workflow are Show Advance ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
