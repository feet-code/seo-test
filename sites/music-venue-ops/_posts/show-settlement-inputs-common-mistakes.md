---
title: "Common Music Venue Show Settlement Reconciliation Mistakes and How to Prevent Them"
...
Ticket counts, comps, fees, expenses, merchandise, guarantees, deposits, and approvals arrive from multiple systems after the show. The recurring failures are usually process-design problems rather than motivation problems. For independent music venues, clubs, and small concert halls, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the settlement input

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every show settlement is built from reconciled inputs with documented variances and approval When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open settlement input needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct settlement input identifier and source without asking the original owner?
