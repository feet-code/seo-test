---
title: "Common Museum Exhibit Maintenance Tracking Mistakes and How to Prevent Them"
...
Visitor reports, gallery checks, AV faults, case concerns, label damage, work restrictions, and reopening decisions cross front-of-house and collections teams. The recurring failures are usually process-design problems rather than motivation problems. For small museums, historic sites, and nonprofit collections teams, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the exhibit issue

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every exhibit issue has an appropriate owner, treatment boundary, visitor plan, and verified closure When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open exhibit issue needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct exhibit issue identifier and source without asking the original owner?
