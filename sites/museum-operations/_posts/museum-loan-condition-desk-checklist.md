---
title: "Museum Object Loan Condition Tracking Checklist for Small Museums, Historic Sites, And Nonprofit Collections Teams"
excerpt: "A copyable quality-control checklist for small museums, historic sites, and nonprofit collections teams, with concrete fields, decision rules, and implementation steps."
...
A checklist for museum object loan condition tracking should prevent missing decisions, not merely prove that somebody clicked boxes. The checklist below is designed for small museums, historic sites, and nonprofit collections teams and centers on one result: **every loan object has a current condition, custody, location, requirement, and due-action record**.

## Before the work starts

- Confirm Loan Object Condition Record identifier and source
...
- Update Open the loan object condition record from a verified source
...
- Update Verify the outcome and close or reschedule the loan object condition record
...
- [ ] Review records where a new loan object condition record is created or its due window changes
...
- [ ] Check for treating a message or scheduled task as completion of the loan object condition record
...
Choose one metric before the next cycle. Good options for this workflow are Loan Object Condition Record ready rate, Open exception age, Repeat exception rate. A checklist that never changes a metric or prevents a known failure mode is probably administrative overhead.
