---
title: "Common Museum Object Loan Condition Tracking Mistakes and How to Prevent Them"
excerpt: "Process mistakes and guardrails for small museums, historic sites, and nonprofit collections teams, with concrete fields, decision rules, and implementation steps."
...
Incoming and outgoing condition notes, packing, locations, display requirements, approvals, and return obligations are distributed across files. The recurring failures are usually process-design problems rather than motivation problems. For small museums, historic sites, and nonprofit collections teams, these are the mistakes worth finding before buying or building software.


### 1. Treating a message or scheduled task as completion of the loan object condition record

This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Customer account site or operating location** at the point of work and enforce this guardrail: Completion requires recorded evidence that every loan object has a current condition, custody, location, requirement, and due-action record When the exception occurs, keep it visible instead of repairing it privately in email.
...
This usually survives because the workflow records activity but not the decision that activity was meant to produce. Add **Exception category impact and decision boundary** at the point of work and enforce this guardrail: Every open loan object condition record needs one owner and a next review time When the exception occurs, keep it visible instead of repairing it privately in email.

## Audit five recent records

Pick five completed or abandoned examples and ask:

- Can we reconstruct loan object condition record identifier and source without asking the original owner?
