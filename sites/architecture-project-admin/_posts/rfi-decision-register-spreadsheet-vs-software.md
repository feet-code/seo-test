---
title: "RFI Decision Register vs. a Spreadsheet: When Software Is Worth It"
...
- One owner can reliably manage register the question and governing references.
- One owner can reliably manage assign the decision owner and needed-by date.
- One owner can reliably manage develop and approve the response.
...
Before migrating, recreate ten current records using the candidate tool. Confirm that it supports these fields without awkward workarounds: Project and RFI number, Question and location, Referenced drawing or specification, Originator and responsible party, Needed-by date, Approved response and attachments, Cost, schedule, and scope impact, Distribution and document-update evidence. Then walk one exception from start to finish. Test exports and deletion before importing the full history.
